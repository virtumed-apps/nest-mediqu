...
async function usuarios({
  ...
  const url =
    'https://api.memed.com.br/v1/sinapse-prescricao/usuarios?api-key=%242y%2410%24N7FvEKj3ZvFlpZwgL2B%2FyOnJiYBeUSOtnA5PmG%2FHmarsGqBEGKUha&secret-key=%242y%2410%243gHoJP8OIxvxjte0uHS9gu4DL%2F9Mr2XCqrumZoT3E51mmtuCFPA2S';
  const body = {
    data: {
      type: 'usuarios',
      attributes: {
